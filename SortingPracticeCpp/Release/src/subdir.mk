...
../src/OptimizedQuickSortTest.cpp \
...
src/%.o: ../src/%.cpp src/subdir.mk
	...
	g++ -std=c++20 -O3 -Wall -c -fmessage-length=0 -MMD -MP -MF"$(@:%.o=%.d)" -MT"$@" -o "$@" "$<"
...
clean-src:
	-$(RM) ./src/ArrayComposition.d ./src/ArrayComposition.o ./src/Disorganizer.d ./src/Disorganizer.o ./src/InitialOrdering.d ./src/InitialOrdering.o ./src/MessageList.d ./src/MessageList.o ./src/OneTestResult.d ./src/OneTestResult.o ./src/OptimizedQuickSortTest.d ./src/OptimizedQuickSortTest.o ./src/ResultOutput.d ./src/ResultOutput.o ./src/SimpleRandomizer.d ./src/SimpleRandomizer.o ./src/SimpleRandomizer_test.d ./src/SimpleRandomizer_test.o ./src/SortAlgorithm.d ./src/SortAlgorithm.o ./src/SortFailureLog.d ./src/SortFailureLog.o ./src/SortFailureLog_test.d ./src/SortFailureLog_test.o ./src/SortMetrics.d ./src/SortMetrics.o ./src/SortTest.d ./src/SortTest.o ./src/SortableObject.d ./src/SortableObject.o ./src/SortingPractice.d ./src/SortingPractice.o ./src/StudentData.d ./src/StudentData.o ./src/StudentDataArray.d ./src/StudentDataArray.o ./src/StudentDataArray_test.d ./src/StudentDataArray_test.o ./src/StudentDataGenerator.d ./src/StudentDataGenerator.o
